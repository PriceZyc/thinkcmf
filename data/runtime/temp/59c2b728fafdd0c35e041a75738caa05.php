<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/portal\admin_pac\index.html";i:1535968256;s:75:"F:\phpstudy\WWW\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1531901242;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('index'); ?>">
        ...
        <select name="class" id="class" style="width: 150px;height: 30px">
            <?php if(is_array($pac_class) || $pac_class instanceof \think\Collection || $pac_class instanceof \think\Paginator): if( count($pac_class)==0 ) : echo "" ;else: foreach($pac_class as $key=>$vo): ?>
                <option value="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
          <span style="margin-left: 20px">URL:</span>
        <input type="text" class="form-control" name="keyword" style="width: 50%;"
               value="<?php echo (isset($keyword) && ($keyword !== '')?$keyword:''); ?>" placeholder="请输入爬取路径...">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(!(empty($vo['url']) || (($vo['url'] instanceof \think\Collection || $vo['url'] instanceof \think\Paginator ) && $vo['url']->isEmpty()))): ?>
                            <a href="javascript:parent.imagePreviewDialog('<?php echo cmf_get_image_preview_url($vo['url']); ?>');">
                                <img src="<?php echo cmf_get_image_preview_url($vo['url']); ?>" alt="">
